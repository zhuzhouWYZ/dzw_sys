...
public class EmpAndBumenAndZhiwei {
	...
	public String toString() {
		return "EmpAndBumenAndZhiwei [employeeno=" + employeeno + ", jurisdictionid=" + jurisdictionid
				...
				+ ", brithtimes=" + brithtimes + ", status=" + status + ", depnames=" + depnames + ", postname="
				+ postname + "]";
	}
